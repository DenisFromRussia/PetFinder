...
from models.predict import get_closest_img_names
...
df = pd.read_sql_table('animals', con=db.engine)
...
app.layout = html.Div(
    ...
    children=[
        upload_img_layout,
        search_layout,
        html.Div(id='search_output_data', style={'padding': '20px 100px 0px 100px'}),
        cards
])
...
@app.callback(
    Output(component_id='cards', component_property='children'),
    #Output(component_id='search_output_data', component_property='children'),
...
if __name__ == '__main__':
    app.run_server(debug=True, host='mn-hdap40', port=8911)